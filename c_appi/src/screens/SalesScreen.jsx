...
const StatusBadge = ({ status }) => {
  const statusStyles = {
    'Pagada': 'bg-green-500/50 text-green-100 ',
    'Pendiente': 'bg-yellow-300/30 text-yellow-100 ',
    'Cancelada': 'bg-red-500/50 text-red-100  ',
    ...
    <div className="p-8 bg-gray-900 min-h-screen font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-2 bg-blue-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors shadow-blue-500/30">
            <Plus size={25} />
            Nueva Venta
          </button>
          <button className="flex items-center gap-2 bg-blue-600 text-white font-bold py-2 px-4 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors shadow-blue-500/30">
            <Download size={25} />
            Exportar
          </button> 
        </div>
